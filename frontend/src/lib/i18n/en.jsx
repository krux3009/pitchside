...
export const EN = {
  ...
  "gamba.sync.blurb": "One account on your phone and laptop. The code IS the account — anyone holding it can use it, and losing it loses the (fake) money.",
  ...
  // spotlight tours (Tour.jsx) — main site + gamba, 4 steps each
  "tour.skip": "Skip",
  "tour.next": "Next",
  "tour.done": "Done",
  "tour.replay.main": "Replay the site tour",
  "tour.replay.gamba": "Replay the Gamba tour",
  "tour.main.hero.t": "Next up",
  "tour.main.hero.b": "The headline card always points at the next kickoff, with a live countdown — and flips to the score once a match is on.",
  "tour.main.nav.t": "Everything lives up here",
  "tour.main.nav.b": "Fixtures, group tables, the knockout bracket, player stats, and head-to-head comparisons.",
  "tour.main.sim.t": "Who wins it all?",
  "tour.main.sim.b": "10,000 tournament simulations, re-run as results land. Model estimates — frequently wrong, never betting advice.",
  "tour.main.gamba.t": "Gamba Mode",
  "tour.main.gamba.b": "A play-money betting simulator on real bookmaker odds, built to show why the book always wins. Fake credits, never real money.",
  "tour.gamba.balance.t": "Your bankroll",
  "tour.gamba.balance.b": "₲500 of play money. Fake credits: no deposits, no withdrawals, no cash value — ever.",
  "tour.gamba.price.t": "Real odds",
  "tour.gamba.price.b": "Live bookmaker consensus. The big number is the best available price; 'med' is the median across books, then how many books quote it.",
  "tour.gamba.slip.t": "The bet slip",
  "tour.gamba.slip.b": "Set a stake and the slip prices your ticket: returns, the model's fair price, and your expected value — usually negative. That gap is the house edge, and the whole lesson.",
  "tour.gamba.school.t": "Settling up",
  "tour.gamba.school.b": "Every market settles on the 90-minute score. School keeps count of what the margin costs you, with your own numbers as proof.",
