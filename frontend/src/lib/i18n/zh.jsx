...
export const ZH = {
  ...
  "gamba.sync.blurb": "手机和电脑共用一个账户。同步码就是账户本身——拿到码的人就能用，码丢了（假）钱也就没了。",
  ...
  // 聚光灯新手引导（Tour.jsx）——主站 + Gamba 各 4 步
  "tour.skip": "跳过",
  "tour.next": "下一步",
  "tour.done": "完成",
  "tour.replay.main": "重看站点引导",
  "tour.replay.gamba": "重看 Gamba 引导",
  "tour.main.hero.t": "下一场",
  "tour.main.hero.b": "头条卡片永远指向下一场开球，带实时倒计时——比赛进行中会自动切成比分。",
  "tour.main.nav.t": "一切都在这里",
  "tour.main.nav.b": "赛程、小组积分、淘汰赛对阵树、球员数据、球队对比。",
  "tour.main.sim.t": "谁能夺冠？",
  "tour.main.sim.b": "一万次赛事模拟，每有新结果就重跑。模型估计——经常出错，绝不是投注建议。",
  "tour.main.gamba.t": "Gamba 模拟投注",
  "tour.main.gamba.b": "基于真实博彩赔率的游戏币投注模拟器，为了演示庄家为什么永远赢。纯虚拟积分，永远不是真钱。",
  "tour.gamba.balance.t": "你的本金",
  "tour.gamba.balance.b": "₲500 游戏币。纯虚拟积分：不能充值、不能提现、没有任何现金价值——永远如此。",
  "tour.gamba.price.t": "真实赔率",
  "tour.gamba.price.b": "博彩公司实时共识。大数字是可拿到的最优价；「中位」是各家的中位数，后面是报价的公司数量。",
  "tour.gamba.slip.t": "注单",
  "tour.gamba.slip.b": "填入注额，注单会算出：回报、模型公允价、以及你的期望值——通常是负的。这个差距就是抽水，也是全部课程。",
  "tour.gamba.school.t": "结算规则",
  "tour.gamba.school.b": "所有玩法按 90 分钟比分结算。「庄家课堂」会用你自己的数字记录抽水到底花了你多少钱。",
